...
function getInput() {
    //user inputs information through prompt
    var userInput = []
...
function calculateDay() {
    ...
    var dayIndex = dayIndex.toFixed(); //number
    dob = days[dayIndex]
    userAkanName = cloneList[dayIndex]; //kwasi
    submit();

}
function submit(userAkanName, useDob) {

    var msg = "Your Akan name is: ".concat(userAkanName);
    msg.concat("\n You were born on a: ").concat(useDob);
    alert(msg);
